...
#include "LifeGamePhaseAbility.generated.h"
...
class ULifeGamePhaseAbility : public ULifeGameplayAbility
{
	GENERATED_BODY()

public:

	ULifeGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Life|Game Phase")
