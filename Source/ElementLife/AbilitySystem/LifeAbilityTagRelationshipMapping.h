...
#include "LifeAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FLifeAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class ULifeAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FLifeAbilityTagRelationship> AbilityTagRelationships;
