...
#include "LifeGameplayCueManager.generated.h"
 ...
 */
UCLASS()
class ULifeGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	ULifeGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static ULifeGameplayCueManager* Get();
