...
#include "LifeTextHotfixConfig.generated.h"
...
class ULifeTextHotfixConfig : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	ULifeTextHotfixConfig(const FObjectInitializer& ObjectInitializer);
