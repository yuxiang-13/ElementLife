...
int32 ULifeHotfixManager::GameHotfixCounter = 0;

ULifeHotfixManager::ULifeHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &ULifeHotfixManager::GetOnScreenMessages);
...
void ULifeHotfixManager::Init()
{
	Super::Init();
}

void ULifeHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
...
bool ULifeHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool ULifeHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool ULifeHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool ULifeHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void ULifeHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void ULifeHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
bool ULifeHotfixManager::PreProcessDownloadedFileData(TArray<uint8>& FileData) const
{
...
#if !UE_BUILD_SHIPPING
void ULifeHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void ULifeHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void ULifeHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
