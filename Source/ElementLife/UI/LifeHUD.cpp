...
ALifeHUD::ALifeHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void ALifeHUD::PreInitializeComponents()
{
...
void ALifeHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void ALifeHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
