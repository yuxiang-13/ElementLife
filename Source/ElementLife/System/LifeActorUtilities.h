...
#include "LifeActorUtilities.generated.h"
...
UCLASS()
class ULifeActorUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Life", meta=(WorldContext="WorldContextObject", ExpandEnumAsExecs=ReturnValue))
