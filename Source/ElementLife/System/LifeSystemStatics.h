...
#include "LifeSystemStatics.generated.h"

class UMeshComponent;

UCLASS()
class ULifeSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Life", meta = (WorldContext = "WorldContextObject"))
