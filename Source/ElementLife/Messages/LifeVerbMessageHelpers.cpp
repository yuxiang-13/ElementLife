...
#include "LifeVerbMessageHelpers.h"
...
FString FLifeVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FLifeVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* ULifeVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* ULifeVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters ULifeVerbMessageHelpers::VerbMessageToCueParameters(const FLifeVerbMessage& Message)
{
...
FLifeVerbMessage ULifeVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FLifeVerbMessage Result;
