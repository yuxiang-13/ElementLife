...
class ALifeGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	ALifeGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	const ULifePawnData* GetPawnDataForController(const AController* InController) const;
