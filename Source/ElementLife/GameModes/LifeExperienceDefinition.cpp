...
#define LOCTEXT_NAMESPACE "LifeSystem"

ULifeExperienceDefinition::ULifeExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult ULifeExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void ULifeExperienceDefinition::UpdateAssetBundleData()
{
