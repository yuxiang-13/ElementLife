...
#include "Source/Public/Messaging/CommonGameDialog.h"
...
template<> COMMONGAME_API UScriptStruct* StaticStruct<FConfirmationDialogAction>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConfirmationDialogAction, Result), Z_Construct_UEnum_CommonGame_ECommonMessagingResult, METADATA_PARAMS(Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewProp_Result_MetaData)) }; // 573681417
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewProp_OptionalDisplayText = { "OptionalDisplayText", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConfirmationDialogAction, OptionalDisplayText), METADATA_PARAMS(Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewProp_OptionalDisplayText_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewProp_OptionalDisplayText_MetaData)) };
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_Header = { "Header", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCommonGameDialogDescriptor, Header), METADATA_PARAMS(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_Header_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_Header_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_Body = { "Body", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCommonGameDialogDescriptor, Body), METADATA_PARAMS(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_Body_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_Body_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_ButtonActions_Inner = { "ButtonActions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FConfirmationDialogAction, METADATA_PARAMS(nullptr, 0) }; // 3351197958
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_ButtonActions = { "ButtonActions", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCommonGameDialogDescriptor, ButtonActions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_ButtonActions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_ButtonActions_MetaData)) }; // 3351197958
	...
	struct Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ScriptStructInfo[] = {
		{ FConfirmationDialogAction::StaticStruct, Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewStructOps, TEXT("ConfirmationDialogAction"), &Z_Registration_Info_UScriptStruct_ConfirmationDialogAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConfirmationDialogAction), 3351197958U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonGameDialogDescriptor, UCommonGameDialogDescriptor::StaticClass, TEXT("UCommonGameDialogDescriptor"), &Z_Registration_Info_UClass_UCommonGameDialogDescriptor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameDialogDescriptor), 1315400875U) },
		{ Z_Construct_UClass_UCommonGameDialog, UCommonGameDialog::StaticClass, TEXT("UCommonGameDialog"), &Z_Registration_Info_UClass_UCommonGameDialog, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameDialog), 2040562756U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_164795161(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ScriptStructInfo),
		nullptr, 0);
