...
#include "Source/Public/PrimaryGameLayout.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPrimaryGameLayout_RegisterLayer_Statics::NewProp_LayerTag = { "LayerTag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PrimaryGameLayout_eventRegisterLayer_Parms, LayerTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(Z_Construct_UFunction_UPrimaryGameLayout_RegisterLayer_Statics::NewProp_LayerTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UPrimaryGameLayout_RegisterLayer_Statics::NewProp_LayerTag_MetaData)) }; // 802167388
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPrimaryGameLayout_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPrimaryGameLayout_RegisterLayer, "RegisterLayer" }, // 4279455350
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UPrimaryGameLayout_Statics::NewProp_Layers_ValueProp = { "Layers", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UCommonActivatableWidgetContainerBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPrimaryGameLayout_Statics::NewProp_Layers_Key_KeyProp = { "Layers_Key", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(nullptr, 0) }; // 802167388
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UPrimaryGameLayout_Statics::NewProp_Layers = { "Layers", nullptr, (EPropertyFlags)0x0040008000002008, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPrimaryGameLayout, Layers), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPrimaryGameLayout_Statics::NewProp_Layers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPrimaryGameLayout_Statics::NewProp_Layers_MetaData)) }; // 802167388
	...
	struct Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPrimaryGameLayout, UPrimaryGameLayout::StaticClass, TEXT("UPrimaryGameLayout"), &Z_Registration_Info_UClass_UPrimaryGameLayout, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPrimaryGameLayout), 3839244087U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h_917181011(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
