...
#include "Source/Public/GameUIPolicy.h"
#include "Source/Public/GameUIManagerSubsystem.h"
...
template<> COMMONGAME_API UScriptStruct* StaticStruct<FRootViewportLayoutInfo>()
{
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewProp_RootLayout = { "RootLayout", nullptr, (EPropertyFlags)0x0010000000082008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRootViewportLayoutInfo, RootLayout), Z_Construct_UClass_UPrimaryGameLayout_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewProp_RootLayout_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewProp_RootLayout_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewProp_bAddedToViewport = { "bAddedToViewport", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRootViewportLayoutInfo), &Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewProp_bAddedToViewport_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewProp_bAddedToViewport_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewProp_bAddedToViewport_MetaData)) };
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_LayoutClass = { "LayoutClass", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameUIPolicy, LayoutClass), Z_Construct_UClass_UPrimaryGameLayout_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_LayoutClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_LayoutClass_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_RootViewportLayouts_Inner = { "RootViewportLayouts", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRootViewportLayoutInfo, METADATA_PARAMS(nullptr, 0) }; // 4283192612
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_RootViewportLayouts_MetaData[] = {
		{ "ModuleRelativePath", "Public/GameUIPolicy.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_RootViewportLayouts = { "RootViewportLayouts", nullptr, (EPropertyFlags)0x0040008000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameUIPolicy, RootViewportLayouts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_RootViewportLayouts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_RootViewportLayouts_MetaData)) }; // 4283192612
	...
	struct Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::EnumInfo[] = {
		{ ELocalMultiplayerInteractionMode_StaticEnum, TEXT("ELocalMultiplayerInteractionMode"), &Z_Registration_Info_UEnum_ELocalMultiplayerInteractionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 9821275U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ScriptStructInfo[] = {
		{ FRootViewportLayoutInfo::StaticStruct, Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewStructOps, TEXT("RootViewportLayoutInfo"), &Z_Registration_Info_UScriptStruct_RootViewportLayoutInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRootViewportLayoutInfo), 4283192612U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameUIPolicy, UGameUIPolicy::StaticClass, TEXT("UGameUIPolicy"), &Z_Registration_Info_UClass_UGameUIPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameUIPolicy), 2894737759U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_3721819767(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::EnumInfo));
