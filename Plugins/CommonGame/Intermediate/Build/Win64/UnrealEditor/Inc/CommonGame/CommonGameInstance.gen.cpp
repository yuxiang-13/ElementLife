...
#include "Source/Public/CommonGameInstance.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_Privilege = { "Privilege", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CommonGameInstance_eventHandlePrivilegeChanged_Parms, Privilege), Z_Construct_UEnum_CommonUser_ECommonUserPrivilege, METADATA_PARAMS(nullptr, 0) }; // 3520582230
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_OldAvailability_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_OldAvailability = { "OldAvailability", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CommonGameInstance_eventHandlePrivilegeChanged_Parms, OldAvailability), Z_Construct_UEnum_CommonUser_ECommonUserAvailability, METADATA_PARAMS(nullptr, 0) }; // 152116938
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_NewAvailability_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_NewAvailability = { "NewAvailability", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CommonGameInstance_eventHandlePrivilegeChanged_Parms, NewAvailability), Z_Construct_UEnum_CommonUser_ECommonUserAvailability, METADATA_PARAMS(nullptr, 0) }; // 152116938
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage_Statics::NewProp_MessageType = { "MessageType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CommonGameInstance_eventHandleSystemMessage_Parms, MessageType), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(nullptr, 0) }; // 802167388
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage_Statics::NewProp_Title = { "Title", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CommonGameInstance_eventHandleSystemMessage_Parms, Title), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CommonGameInstance_eventHandleSystemMessage_Parms, Message), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonGameInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged, "HandlePrivilegeChanged" }, // 451774791
		{ &Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage, "HandleSystemMessage" }, // 204052835
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonGameInstance, UCommonGameInstance::StaticClass, TEXT("UCommonGameInstance"), &Z_Registration_Info_UClass_UCommonGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameInstance), 3601798125U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_CommonGameInstance_h_528281838(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
