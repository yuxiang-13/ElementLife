...
// End Cross Module References
	...
	static UEnum* EGameplayMessageMatch_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EGameplayMessageMatch.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_GameplayMessageRuntime_EGameplayMessageMatch, Z_Construct_UPackage__Script_GameplayMessageRuntime(), TEXT("EGameplayMessageMatch"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_GameplayMessageRuntime_EGameplayMessageMatch_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_GameplayMessageRuntime_EGameplayMessageMatch_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_GameplayMessageRuntime_EGameplayMessageMatch_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_ElementLife_Plugins_GameplayMessageRouter_Source_GameplayMessageRuntime_Public_GameFramework_GameplayMessageTypes2_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_GameplayMessageRouter_Source_GameplayMessageRuntime_Public_GameFramework_GameplayMessageTypes2_h_Statics::EnumInfo[] = {
		{ EGameplayMessageMatch_StaticEnum, TEXT("EGameplayMessageMatch"), &Z_Registration_Info_UEnum_EGameplayMessageMatch, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2602077705U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ElementLife_Plugins_GameplayMessageRouter_Source_GameplayMessageRuntime_Public_GameFramework_GameplayMessageTypes2_h_2152338118(TEXT("/Script/GameplayMessageRuntime"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_ElementLife_Plugins_GameplayMessageRouter_Source_GameplayMessageRuntime_Public_GameFramework_GameplayMessageTypes2_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ElementLife_Plugins_GameplayMessageRouter_Source_GameplayMessageRuntime_Public_GameFramework_GameplayMessageTypes2_h_Statics::EnumInfo));
